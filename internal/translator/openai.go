...
func NewDeepSeek(providerModel, baseURL string) *OpenAICompatTranslator {
	if baseURL == "" {
...
func NewGrok(providerModel, baseURL string) *OpenAICompatTranslator {
	if baseURL == "" {
...
func NewGLM(providerModel, baseURL string) *OpenAICompatTranslator {
	if baseURL == "" {
...
func (t *OpenAICompatTranslator) endpointURL() string {
	return t.baseURL + "/chat/completions"
}

func (t *OpenAICompatTranslator) buildHTTPRequest(
	ctx context.Context,
...
func (t *OpenAICompatTranslator) ToUpstream(
	ctx context.Context,
	req *types.MessageRequest,
	credential cred.Credential,
) (*http.Request, error) {
...
func (t *OpenAICompatTranslator) ToUpstreamStream(
	ctx context.Context,
	req *types.MessageRequest,
	credential cred.Credential,
) (*http.Request, error) {
...
func (t *OpenAICompatTranslator) FromUpstream(resp *http.Response) (*types.MessageResponse, error) {
...
func (t *OpenAICompatTranslator) StreamFromUpstream(
	ctx context.Context,
	resp *http.Response,
